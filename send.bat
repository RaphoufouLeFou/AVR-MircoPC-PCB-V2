avr-g++ -c -O3 -w -mmcu=ATmega128a -DF_CPU=20000000L main.c -o main.o
...
avr-gcc -O3 -Wl,--gc-sections,--section-start=.FAR_MEM1=0x10000,--section-start=.FAR_MEM2=0x20000,--section-start=.FAR_MEM3=0x30000 -mmcu=atmega128a -w -flto -g RayTracing.o driver.o main.o Display.o -o main.elf
